...
public class ExperimentalFeatures {
    ...
    private void sendPlayerInput(UserConnection user, boolean startUsing) {
        final PacketWrapper pckt = PacketWrapper.create(ServerboundBedrockPackets.PLAYER_ACTION, user);
        pckt.write(Types.FLOAT, 0f);
        pckt.write(Types.FLOAT, 0f);
        pckt.write(Types.BOOLEAN, startUsing);
        pckt.sendToServer(BedrockProtocol.class);
    }
